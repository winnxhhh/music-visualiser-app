...
function Needles(){
	...
	this.draw = function(){
		...
		for (var i = 0; i < this.plotsDown; i++) 
		{
			for (var j = 0; j < this.plotsAcross; j++) 
			{
				...
				var x = this.pad + j * this.plotWidth - 30;
				var y = this.pad + i * this.plotHeight - 30;
				var w = this.plotWidth - this.pad + 60;
				var h = this.plotHeight - this.pad + 60;
	...
	this.ticks = function(centreX, bottomY, freqLabel){
		// 8 ticks from 180 degrees to 360 degrees
